      ...
      <div className="px-6 md:px-16 lg:px-32 pt-14 space-y-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div className="flex flex-col">
            ...
            {/* return policy */}
            <div className="text-sm text-gray-700/80 flex flex-col gap-3 mt-4">
              <div className="flex items-center gap-2 bg-orange-50 border border-orange-200 px-3 py-2 rounded-lg">
                <RotateCcw className="w-5 h-5 text-orange-600" />
                <span className="font-semibold text-orange-800">Easy Return Policy:</span>
                <span className="text-gray-700 font-semibold">7 days</span>
              </div>
            </div>
