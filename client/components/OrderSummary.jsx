...
// const FREE_SHIPPING_THRESHOLD = 1500; // Show delivery charge if total < this
// const DELIVERY_FEE = 125; // Updated delivery fee when under threshold
...
//           sp_each,
//           cashback_amount,
//           delivery_amount: 0, // kept per-item as 0; order-level shipping included in total_amount
//         };
//       });

//       const payload = {
//         shipping_address_id: selectedAddress._id,
//         total_amount: Number(grandTotal.toFixed(2)), // include shipping fee
//         items,
//         // Optional: include explicit shipping for server visibility
...
//         return;
//       }
//       alert(res?.data?.error || "Could not place order.");
//     } catch (e) {
